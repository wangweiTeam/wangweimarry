        ...
        <div class="main-wrap">
            ...
            <div class="user-info">
                ...
                <div class="user-infoPic">
                    <div class="filePic">
                        <label for="pic"></label>
                        <img id="pic" name="pic" width="80" height="80" src="${items.pic}" />
                    ...
                    <div class="info-m">
                        ...
                        <div class="user-tel">
                            <b>联系方式：</b>${sessionScope.user.telephone}
                        </div>
                        <div class="user-email">
                            <b>邮箱：</b>${sessionScope.user.email}
                        </div>
                    </div>
                </div>
                <label>${requestScope.mesg}</label>
                <!--个人信息 -->
                <div class="info-main">
                    <form class="am-form am-form-horizontal" action="/user?method=addInformation" method="post">

                        <div class="am-form-group">
                            <label for="user-name" class="am-form-label">姓名</label>
                            <div class="am-form-content">
                                <input type="text" id="user-name" placeholder="请输入真实姓名" name="name" value="${sessionScope.user.getName()}"/>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            <label  class="am-form-label">出生日期</label>
                            <div id="date" style="margin-left: 90px;">
                                ...
                                <select id="days" name="days" style="padding: 5px;outline: none; width: 200px">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-form-content">
                                <input type="text" id="user-account" placeholder="请输入银行卡号" name="acountID">
                            </div>
                        </div>
